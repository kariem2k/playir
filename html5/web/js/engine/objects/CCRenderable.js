...
CCRenderable.prototype.setRotation = function(rotationVector)
{
    this.rotation[0] = rotationVector[0];
    this.rotation[1] = rotationVector[1];
    this.rotation[2] = rotationVector[2];
...
CCRenderable.prototype.rotateX = function(x)
{
    this.rotation[0] += x;
    this.rotation[0] = CC.ClampRotation( this.rotation[0] );
    this.rotationUpdated();
};
