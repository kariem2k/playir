...
function CCTile3DButton(scene, setupTile)
{
...
CCTile3DButton.prototype.setupText = function(text, height, centered, createBackgroundTile)
{
    ...
    if( !centered )
    {
        this.textObject.setPositionX( -width * 0.5 );
    }
...
{
    if( this.visibleOnlyUpdate && !this.visible )
    {
        return false;
    }
...
CCTile3DButton.prototype.set3DModelRotation = function(rotationVector)
{
    if( this.model3dObject )
    {
        if( typeof( rotationVector ) === "string" )
        {
            rotationVector = vec3.fromString( rotationVector );
        }
        this.model3dObject.setRotation( rotationVector );
    }
};
...
CCTile3DButton.prototype.flipTileX = function()
{
