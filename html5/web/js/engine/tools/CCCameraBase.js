...
CCCameraBase.prototype.updateOffset = function(offsetTarget)
{
	...
	CC.RotateAboutX( rotatedPosition, rotation[0], position, lookAt );
	CC.RotateAboutY( rotatedPosition, rotation[1], rotatedPosition, lookAt );
};
...
CCCameraBase.prototype.updateLookAtDirection = function(position, direction)
{
	...
	CC.RotateAboutX( lookAt, rotation[0], lookAt, position );
	CC.RotateAboutY( lookAt, rotation[1], lookAt, position );
};
...
CCCameraBase.prototype.updateVisibleCollideables = function()
{
    ...
    {
        CC.ScanVisibleCollideables( this.frustum, CCCollisionManager.collideables, this.visibleCollideables );
    }
