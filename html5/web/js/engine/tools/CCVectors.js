...
vec3.addValue = function(vector, value)
{
    vec3.add( vector, vector, [value, value, value] );
};
...
CCColour.Red = new CCColour().setRGBA( 0.5, 0.0, 0.0, 1.0 );
CCColour.LightRed = new CCColour().setRGBA( 0.75, 0.25, 0.25, 1.0 );

CCColour.LightBlue = new CCColour().setRGBA( 0.25, 0.5, 0.75, 1.0 );
CCColour.LightYellow = new CCColour().setRGBA( 0.75, 0.75, 0.25, 1.0 );

CCColour.Grey = new CCColour().set( 0.25, 1.0 );
CCColour.LightGrey = new CCColour().set( 0.75, 1.0 );

CCColour.Green = new CCColour().setRGBA( 0.125, 0.75, 0.0, 1.0 );
CCColour.LightGreen = new CCColour().setRGBA( 0.25, 0.75, 0.25, 1.0 );
