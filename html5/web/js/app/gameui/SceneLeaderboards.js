...
SceneLeaderboards.prototype.setup = function()
{
    ...
    var tileWidth = camera.targetWidth * 0.3;
    {
        ...
        tile.setupTexturedWidth( tileWidth, "ui_leaderboards_daily.png" );
    ...
    {
        tile = new CCTile3DButton( this );
        tile.setupTexturedWidth( tileWidth, "ui_leaderboards_weekly.png" );
    ...
    {
        tile = new CCTile3DButton( this );
        tile.setupTexturedWidth( tileWidth, "ui_leaderboards_alltime.png" );
