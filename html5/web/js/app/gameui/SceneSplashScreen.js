...
function SceneSplashScreen()
{
    ...
    gEngine.textureManager.getTextureHandle( "ui_vs.png" );
    gEngine.textureManager.getTextureHandle( "ui_vs_whitestripe.png" );
    gEngine.textureManager.getTextureHandle( "ui_vs_bluestripe.png" );
    gEngine.textureManager.getTextureHandle( "ui_vs_redstripe.png" );
}
...
SceneSplashScreen.prototype.setup = function()
{
    ...
    this.tileWhiteStripe.setupTextured( "ui_vs_whitestripe.png", function()
    {
        self.tileBlueStripe.setupTextured( "ui_vs_bluestripe.png", function()
        {
            self.tileRedStripe.setupTextured( "ui_vs_redstripe.png", function()
            {
                self.tileBlueStripe.positionTileAbove( self.tileWhiteStripe );
                {
                    tile = new CCTile3DButton( self );
                    tile.setupTextured( "ui_vs_whitestripe.png" );
