...
ScenePlayScreen.prototype.setup = function()
{
    ...
    var tile;
    {
        ...
        tile.setupTexturedWidth( borderWidth, "resources/common/uimenu/ui_sidebackground.png", function()
        {
            self.imageLoaded();
        });
    ...
    {
        tile = new CCTile3DButton( this );
        tile.setupTexturedWidth( borderWidth, "resources/common/uimenu/ui_practice.png", function()
        {
            self.imageLoaded();
        });
    ...
    {
        tile = new CCTile3DButton( this );
        tile.setupTexturedWidth( borderWidth, "resources/common/uimenu/ui_leaderboards.png", function()
        {
            self.imageLoaded();
        });
    ...
    {
        tile = new CCTile3DButton( this );
        tile.setupTexturedWidth( borderWidth, "resources/common/uimenu/ui_help.png", function()
        {
            self.imageLoaded();
        });
    ...
    // Switch teams
    {
        {
            tile = new CCTile3DButton( this );
            tile.setupTexturedWidth( borderWidth * 0.5, "resources/common/uimenu/ui_arrow.png", function()
            {
                self.imageLoaded();
            });
        ...
        {
            tile = new CCTile3DButton( this );
            tile.setupTexturedWidth( borderWidth * 0.5, "resources/common/uimenu/ui_arrow.png", new OnImageDownloaded( tile ) );
    ...
    // Play modes
    {
        ...
        {
            tile = new CCTile3DButton( this );
            tile.setupTexturedWidth( borderWidth * 1.25, "resources/common/uimenu/ui_button_1vs1.png", function()
            {
                self.imageLoaded();
            });
        ...
        {
            tile = new CCTile3DButton( this );
            tile.setupTexturedWidth( borderWidth * 1.25, "resources/common/uimenu/ui_button_battleroyale.png", function()
            {
                self.imageLoaded();
            });
...
ScenePlayScreen.prototype.enablePushNotifications = function()
{
    ...
    //     tile->setupTexturedWidth( tile->collisionSize.width, "resources/common/uimenu/ui_pushnotifications_on.png", Resource_Packaged, true );
    // }
};
...
ScenePlayScreen.prototype.disablePushNotifications = function()
{
    ...
    // {
    //     CCTile3DButton *tile = tilePushNotifications;
    //     tile->setupTexturedWidth( tile->collisionSize.width, "resources/common/uimenu/ui_pushnotifications_off.png", Resource_Packaged, true );
    // }
};
...
ScenePlayScreen.prototype.launchMulti = function()
{
    if( this.sceneMultiLauncher )
    {
