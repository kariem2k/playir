...
CharacterPlayer.prototype.setWeaponBulletSpeed = function(bulletSpeed)
{
    var weapons = this.weapons;
    ...
    {
        var weapon = weapons[i];
        weapon.setupBullet( null, bulletSpeed );
    }
};
...
{
    this.sceneMap.registerDeath( this.playerID, killer, false );
};
