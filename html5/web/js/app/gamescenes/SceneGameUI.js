...
SceneGameUI.prototype.setup = function()
{
    ...
    var LoadPlayerTileImages = function(playerTile)
    {
        return function()
        {
            ...
            {
                playerTile.tileFireCharge[i].setupTexturedHeight( height, "ui_fire_charge.png", function()
                {
                    self.requestResize();
                });
            }
    ...
    for( var playerIndex=0; playerIndex<playerTiles.length; ++playerIndex )
    {
        ...
        // Fire
        {
            {
                tile = new CCTile3DButton( this );
                tile.setupTexturedWidth( camera.cameraWidth * 0.05, "ui_fire_icon.png", function()
                {
                    self.requestResize();
                });
                tile.getTileScaleInterpolator().setDuration( 0.25 );
        ...
        playerTile.tileHealthIcon.setupTexturedWidth( camera.cameraWidth * 0.05, "ui_health_icon.png", new LoadPlayerTileImages( playerTile ) );
    }

    {
        tile = new CCTile3DButton( this );
        tile.setupTexturedWidth( camera.cameraWidth * 0.085, "ui_back.png", function()
        {
            self.requestResize();
        });
...
SceneGameUI.prototype.fight = function()
{
    ...
    tile.setupTexturedWidth( camera.cameraWidth * 0.2, "ui_fight.png" );
...
SceneGameUI.prototype.win = function()
{
    var camera = this.camera;
    var tile = this.tileNotification;
    tile.setupTexturedWidth( camera.cameraWidth * 0.2, "ui_win.png" );
    tile.setColourAlpha( 0.0 );
...
SceneGameUI.prototype.lose = function()
{
    var camera = this.camera;
    var tile = this.tileNotification;
    tile.setupTexturedWidth( camera.cameraWidth * 0.2, "ui_lose.png" );
    tile.setColourAlpha( 0.0 );
