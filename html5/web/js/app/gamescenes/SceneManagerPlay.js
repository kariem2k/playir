...
SceneManagerPlay.prototype.disconnected = function()
{
};
...
SceneManagerPlay.SpawnCharacter = function(type, onLoadedCallback)
{
    ...
    if( String.Contains( type, "burger" ) ||
        String.Contains( type, "fries" ) )
    {
        return CharacterPlayerBurger.Spawn( type, onLoadedCallback );
    }
    else if( String.Contains( type, "androBot" ) ||
             String.Contains( type, "iBot" ) ||
             String.Contains( type, "winBot" ) )
    {
        return CharacterPlayerAndroid.Spawn( type, onLoadedCallback );
    }
    else if( String.Contains( type, "webBot" ) )
    {
        return CharacterPlayerWeb.Spawn( type, onLoadedCallback );
    }
    else if( String.Contains( type, "soldier" ) ||
             String.Contains( type, "miniche" ) )
    {
        return CharacterPlayerSoldier.Spawn( type, onLoadedCallback );
    }
    else if( String.Contains( type, "tank" ) )
    {
