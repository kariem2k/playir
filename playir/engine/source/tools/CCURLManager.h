...
struct CCURLRequest
{
    ...
    int cacheFileTimeoutSeconds;	// How long before our cache file becomes invalid
...
public:
    ...
    void requestURLAndCache(const char *url,
                            ...
                            const int cacheFileTimeoutSeconds=-1);
    ...
    void requestURLAndCacheAfterTimeout(const char *url,						// The URL to request
                                        ...
                                        const int cacheFileTimeoutSeconds=-1,	// How long before our cache file becomes invalid
