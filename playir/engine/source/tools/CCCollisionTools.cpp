...
{
    CCList<CCCollideable> &collideables = gEngine->collisionManager.collideables;
...
void CCOctreeCollisionCheckAsync(CCCollideable *sourceObject, const CCVector3 &targetLocation, CCList<CCCollideable> &collisions)
{
    CCVector3 sourceMin = CCVector3( targetLocation.x - sourceObject->collisionBounds.x,
                                     targetLocation.y - sourceObject->collisionBounds.y,
                                     targetLocation.z - sourceObject->collisionBounds.z );
...
void CCOctreeMovementCollisionCheckAsync(CCCollideable *sourceObject, CCVector3 currentPosition, const CCVector3 &targetPosition, CCList<CCCollideable> &collisions)
{
