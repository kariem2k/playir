...
void CCDeviceRenderer::GLClear(const bool colour)
{
	if( colour )
	{
...
void CCDeviceRenderer::glEnable(const GLenum cap)
{
	...
	else if( cap == GL_BLEND )
	{
		...
		desc.RenderTarget[0].SrcBlend  = GL_SRC_ALPHA;
		desc.RenderTarget[0].DestBlend = GL_ONE_MINUS_SRC_ALPHA;
		desc.RenderTarget[0].SrcBlendAlpha = D3D11_BLEND_ONE;
		desc.RenderTarget[0].DestBlendAlpha = GL_ONE_MINUS_SRC_ALPHA;
