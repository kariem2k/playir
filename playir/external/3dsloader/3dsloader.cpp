		...
		switch( l_chunk_id )
		{
			...
			case 0x4120:
			{
				...
				for (i=0; i<l_qty; i++)
				{
                    ...
                    CCASSERT( p_object->polygon[i].a >= 0 && p_object->polygon[i].a < p_object->vertices_qty );

					file->read( &p_object->polygon[i].b, sizeof (unsigned short)  );
					//DEBUGLOG("Polygon point b: %d\n",p_object->polygon[i].b);
                    CCASSERT( p_object->polygon[i].b >= 0 && p_object->polygon[i].b < p_object->vertices_qty );

					file->read( &p_object->polygon[i].c, sizeof (unsigned short)  );
					//DEBUGLOG("Polygon point c: %d\n",p_object->polygon[i].c);
                    CCASSERT( p_object->polygon[i].c >= 0 && p_object->polygon[i].c < p_object->vertices_qty );
