...
-(id)init
{
    ...
    if( self != NULL )
    {
        ...
        [gViewController registerRotateableView:self];
    }
    return self;
}
...
-(void)dealloc
{
    [gViewController unregisterRotateableView:self];
...
{
    [self setOrientation:[gViewController getInterfaceOrientation] duration:0.125f];
}
