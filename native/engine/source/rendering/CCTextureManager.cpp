...
void CCTextureManager::loadTextureAsync(CCTextureHandle &textureHandle, CCLambdaSafeCallback *callback)
{
    ...
    CCLAMBDA_5( Loaded, CCTextureManager, that, CCTextureBase*, texture, CCText, filePath, CCResourceType, resourceType, bool, mipmap, {
...
//#endif
    ...
    texture->loadAndCreateAsync( textureHandle.filePath.buffer, textureHandle.resourceType, textureHandle.mipmap,
                                 new Loaded( this, texture, textureHandle.filePath, textureHandle.resourceType, textureHandle.mipmap ) );
}
