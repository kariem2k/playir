...
extern void CCOctreeCollisionCheckAsync(CCCollideable *sourceObject, const CCVector3 &targetLocation, CCList<CCCollideable> &collisions);
extern void CCOctreeMovementCollisionCheckAsync(CCCollideable *sourceObject, CCVector3 currentPosition, const CCVector3 &targetPosition, CCList<CCCollideable> &collisions);
