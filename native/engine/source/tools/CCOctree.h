...
extern void CCOctreeListVisibles(CCList<CCOctree> &leafs, CCList<CCCollideable> &collideables);
...
extern void CCScanVisibleCollideables(const float frustum[6][4],
                                      ...
                                      CCList<CCCollideable> &visibleCollideables);
extern void CCOctreeRenderVisibleObjects(CCCameraBase *camera, const CCRenderPass pass, const bool alpha);
