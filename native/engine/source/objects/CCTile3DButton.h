...
public:
    ...
    void setupTextured(const char *textureName, CCResourceType resourceType, CCLambdaCallback *onDownloadCallback, const bool mipmap=false);
...
public:
    ...
    void setTileTexture(const char *textureName, CCResourceType resourceType, CCLambdaCallback *onDownloadCallback,
                        const bool mipmap=false, const bool load=false);
