 ...
 *-----------------------------------------------------------
 * File Name   : CCPrimitiveFBXJS.cpp
 *-----------------------------------------------------------
 */
...
CCPrimitiveFBXJS::CCPrimitiveFBXJS(const char *primitiveID)
{
...
void CCPrimitiveFBXJS::destruct()
{
...
bool CCPrimitiveFBXJS::loadData(const char *fileData)
{
    json_error_t error;
...
int CCPrimitiveFBXJS::loadSubmodel(json_t *json)
{
...
void CCPrimitiveFBXJS::addSubmesh(const int count, const int offset)
{
...
void CCPrimitiveFBXJS::setTextureHandleIndex(const int index)
{
    super::setTextureHandleIndex( index );
}


void CCPrimitiveFBXJS::adjustTextureUVs()
{
...
void CCPrimitiveFBXJS::render()
{
    super::render();
}


void CCPrimitiveFBXJS::renderVertices(const bool textured)
{
...
void CCPrimitiveFBXJS::copy(const CCPrimitiveFBXJS *primitive)
{
...
void CCPrimitiveFBXJS::calculateMinMax()
{
    mmX.reset();
    mmY.reset();
    mmZ.reset();
...
void CCPrimitiveFBXJS::moveVerticesToOrigin()
{
...
void CCPrimitiveFBXJS::movedVerticesToOrigin()
{
...
void CCPrimitiveFBXJS::interpolateFrames(const int currentAnimationIndex, const int currentFrameIndex, const int nextAnimationIndex, const int nextFrameIndex, const float frameDelta)
{
    for( int subModelIndex=0; subModelIndex<submodels.length; ++subModelIndex )
    {
...
float* CCPrimitiveFBXJS::getSubmodelAnimationFrameVertices(const char *submodelName, const AnimationFrame &frame)
{
