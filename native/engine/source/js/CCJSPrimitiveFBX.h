...
class CCJSPrimitiveFBX : public CCPrimitive3D
{
...
public:
    CCJSPrimitiveFBX(const char *primitiveID);
...
public:
    virtual void copy(const CCJSPrimitiveFBX *primitive);
